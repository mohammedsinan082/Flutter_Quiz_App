...
import 'package:flutter_quiz_app/features/survey_page/controller/surveyPage_controller.dart';
...
import 'package:flutter_quiz_app/core/constants/utils.dart';
...
class survey_home_page extends ConsumerStatefulWidget {
  final QuestionModel questionModel;
  const survey_home_page({super.key,required this.questionModel});

  @override
  ConsumerState<survey_home_page> createState() => _survey_home_pageState();
}

class _survey_home_pageState extends ConsumerState<survey_home_page> {
...
//  double time=0;
 ...
 // String selectedAnswer="";
  ...
  createExam() async{
   ...
   await ref.read(SurveyPageControllerProvider.notifier).createExam(quizModel: quizOptionsModel);
...
// //  print(questions[0].toJson());
 ...
 // int qnIndex=0;
  ...
  final qnIndex1=StateProvider<int>((ref){
   return 0;
  });
  @override
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            centerTitle: true,
            title:  Text(
              widget.questionModel.topicName=='Flutter'?'Flutter':widget.questionModel.topicName=="Dart"?"Dart":"Firebase",
              //"Flutter",
          style: GoogleFonts.nunitoSans(fontSize: w*0.077,fontWeight: FontWeight.w700,color: Colors.white)
              // style: TextStyle(
          ...
          body:
             Consumer(
               builder: (context,ref,child) {
                 int qnIndex=ref.watch(qnIndex1);
                 return Column(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    child: Animate(
                      ...
                      child: Text(
                        question,
                          style: GoogleFonts.nunitoSans(fontSize: w*0.047,fontWeight: FontWeight.w600)
                      ),
                    ),
                  ),
                               ...
                               child: Center(
                                 child: Countdown(
                                   ...
                                   build: (BuildContext context, double time) {
                                     ...
                                     return Text(time.toString(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),);
                                     },
                                  ...
                                  //   bool isLastQuestion=false;
                                   ...
                                   if (qnIndex == questions.length - 1) {
                                     ...
                                     ref.read(SurveyPageControllerProvider.notifier).updateData(quizId: quizId, questions: questions);
                                     ...
                                     showDialog(context: context,
                                      ...
                                      ref.watch(qnIndex1.notifier).state++;
                                    //-  qnIndex++;
                                      print(qnIndex);
                                      print("qnIndex");
                                      _controller.restart();
                  ...
                  //  left: 292,
                   ...
                   //   color: Colors.red,
                      child: Row(
                        ...
                        children: [
                          Text(
                            "${ref.watch(qnIndex1.notifier).state + 1}/${details.length.toString()}",
                            style: TextStyle(
  ...
  Widget _answerButton(String dat,String option,String answer) {
    ...
    //             ? question.option_C
    //             : question.option_D;
    String selectedAnswer=ref.watch(selectedAnswer1);
    String options=dat;
    ...
    return Consumer(
      builder: (context,ref,child) {
        ...
        return InkWell(
          onTap: () {
            ref.watch(selectedAnswer1.notifier).update((state) => options);
          //  selectedAnswer=options;55
                ...
                children: [
                  ...
                  Animate(
                    ...
                    child: SizedBox(
                      width: w*0.6,
                      child: Text(options,
                          style: GoogleFonts.nunitoSans(fontSize: w*0.047,fontWeight: FontWeight.w600,color: (
                              (selectedAnswer == answer && answer == options) || (selectedAnswer != answer && answer == options && selectedAnswer == '')) ?
                          Colors.green: (selectedAnswer != answer && answer != options)
                              ? Colors.black : selectedAnswer == '' ? Colors.green : Colors.black
                          )
            ...
            if(selectedAnswer==""){
              ...
              if(isLastQuestion==true){
                ...
                try{
                  ...
                  ref.watch(selectedAnswer1.notifier).update((state) => '');
                //  selectedAnswer="";
                  ref.watch(qnIndex1.notifier).state++;
                 // qnIndex++;33
                  _controller.restart();
    ...
    content: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(child: Text(_getGrade(marks) ,

              //  style: TextStyle(color: ispassed? Colors.green:Colors.red,fontSize: 35,fontWeight: FontWeight.w600),
              style: GoogleFonts.nunitoSans(fontSize: w*0.087,fontWeight: FontWeight.bold,color: ispassed? Colors.green:Colors.red,)
          )),
          Text("${percentage.toInt()}% Score",
              style: GoogleFonts.nunitoSans(fontSize: w*0.087,fontWeight: FontWeight.bold,color: ispassed? Colors.green:Colors.red,)
          ),
          Text("Quiz Completed Succesfully",
              style: GoogleFonts.nunitoSans(fontSize: w*0.047,fontWeight: FontWeight.bold,color: Colors.green.shade700)
          ),
          Container(
            //  width: w*0.7,
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("${details.length.toString()} Questions",style: TextStyle(color: Colors.blue.shade900,fontSize: w*0.045,fontWeight: FontWeight.bold),)
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("from that ", style: TextStyle(fontSize:w*0.035,color:Colors.black),),
                      Text("${marks} Questions",style: TextStyle(color: Colors.green.shade700,fontSize: w*0.045,fontWeight: FontWeight.bold),),
                      Text(" is correct... ", style: TextStyle(fontSize: w*0.035,color:Colors.black),),
                    ],
                  ),
                ],
              )),
